...
Shader "Deeper/GlowSprite"
{
	Properties
	{
		...
		[HDR]_GlowColor("GlowColor", Color) = (0,0.7249274,1,1)
		[HDR]_OutlineColor1("OutlineColor", Color) = (0,0.8065434,1,1)
		_OutlineWidth("OutlineWidth", Range( 0 , 3)) = 1
		[Toggle(_PULSEANIM1_ON)] _PulseAnim1("PulseAnim", Float) = 0
		_PulseSpeed1("PulseSpeed", Float) = 8
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _PULSEANIM1_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_186_0 = ( OutlineAlpha179 * _OutlineColor1 );
			float clampResult187 = clamp( cos( ( _Time.y * _PulseSpeed1 ) ) , 0.1 , 1.0 );
			#ifdef _PULSEANIM1_ON
			...
			float4 lerpResult96 = lerp( ( OutlineEmission190 + rimLight105 + ( tex2D( _Emissive, uv_Emissive ) * _GlowColor ) ) , color94 , _Emission);
...
/*ASEBEGIN
Version=18500
443.2;73.6;815;439;1820.745;588.9314;2.50803;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;101;1001.646,-92.6884;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;False;0;False;75c4272bf5aac534688dcb2fff33adc7;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;25;1309.45,-100.7066;Inherit;True;Property;_TextureSample;TextureSample;1;0;Create;True;0;0;False;0;False;-1;55e137d8c319814479fd5d2f9ce1bdc6;f8acf47736d722947bc40b6ee5c70d6c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;180;1251.912,2257.262;Inherit;False;Property;_PulseSpeed1;PulseSpeed;10;0;Create;True;0;0;False;0;False;8;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;183;1244.185,2580.281;Inherit;False;Property;_OutlineColor1;OutlineColor;7;1;[HDR];Create;True;0;0;False;0;False;0,0.8065434,1,1;0,0.465055,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;153;-1795.85,-445.7237;Inherit;False;1695.481;723.3339;Comment;10;42;41;106;80;43;79;94;98;96;90;Map Emissive;0.06649756,1,0,1;0;0
...
Node;AmplifyShaderEditor.StaticSwitch;189;2333.535,2520.562;Inherit;False;Property;_PulseAnim1;PulseAnim;9;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;41;-1644.189,-38.88876;Inherit;False;Property;_GlowColor;GlowColor;6;1;[HDR];Create;True;0;0;False;0;False;0,0.7249274,1,1;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;42;-1685.657,-260.2902;Inherit;True;Property;_Emissive;Emissive;5;1;[SingleLineTexture];Create;True;0;0;False;0;False;-1;4af45f3b244cf3d43947699ab05065fb;37cf5ce453cc44249813f1baf3d986ed;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;90;-350.2486,-132.8511;Inherit;False;EmissiveMap;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=DE6F4739058CA5FCF49FED92AE77A5B5DEE48BD9